...
export default function FilterBar({
    ...
    return (
        <div className="controls-section max-w-6xl mx-auto px-6 pt-6 relative">
            ...
            {/* Filter Drawer Panel */}
            <div
                className={`fixed z-[900] bg-white shadow-2xl transition-all duration-300 ${showFilterDrawer ? 'opacity-100 pointer-events-auto translate-y-0' : 'opacity-0 pointer-events-none translate-y-4'
                    } 
  /* Mobile: bottom sheet */
  bottom-0 left-0 right-0 rounded-t-3xl p-4 pb-6
  /* Desktop: dropdown below search */
  md:absolute md:top-full md:left-1/2 md:-translate-x-1/2 md:bottom-auto md:rounded-2xl md:mt-3 md:max-w-xl md:w-full md:p-6
            ...
            >
                ...
                <div className="flex items-start justify-between pb-4 border-b border-gray-100 mb-4">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-indigo-50 text-indigo-600 rounded-full text-xs font-bold hover:bg-indigo-100 transition"
                    >
                        Clear All
                    </button>
                </div>
                ...
                <button
                    onClick={onCloseDrawer}
                    className="w-full max-w-md mx-auto block min-h-[46px] bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-extrabold text-sm shadow-xl hover:shadow-2xl transition"
                >
                    Apply Filters
                </button>
            </div>
